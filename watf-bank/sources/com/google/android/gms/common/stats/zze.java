    ...
    public static void zza(Context context, String str, int i, String str2, String str3, String str4, int i2, List<String> list, long j) {
        ...
        if (zzgdz.booleanValue()) {
            ...
            if (7 == i || 8 == i || 10 == i || 11 == i) {
                ...
                try {
                    context.startService(new Intent().setComponent(zzb.zzgdd).putExtra("com.google.android.gms.common.stats.EXTRA_LOG_EVENT", new WakeLockEvent(currentTimeMillis, i, str2, i2, list3, str, elapsedRealtime, zzcw, str3, "com.google.android.gms".equals(packageName) ? null : packageName, zzj.zzcx(context), j, str4)));
                } catch (Exception e) {

...
public final class zzdup {
    ...
    public static ECParameterSpec zza(zzdur zzdurVar) throws NoSuchAlgorithmException {
        String str;
        String str2;
        String str3;
        String str4;
        String str5;
        int i = zzduq.zzlzd[zzdurVar.ordinal()];
        if (i == 1) {
            ...
            String valueOf = String.valueOf(zzdurVar);

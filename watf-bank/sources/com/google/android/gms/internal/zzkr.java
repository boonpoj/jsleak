...
public final class zzkr extends zzeu implements zzkq {
    ...
    public static abstract class zza extends Binder implements zzkr {
        ...
        /* loaded from: assets/classes2.dex */
        private static class C0057zza implements zzkr {
        ...
        public static zzkr zzT(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzkr)) ? new C0057zza(iBinder) : (zzkr) queryLocalInterface;
        }
    ...
    public final IBinder zza(IObjectWrapper iObjectWrapper, String str, zzux zzuxVar, int i) throws RemoteException {
        Parcel zzbe = zzbe();

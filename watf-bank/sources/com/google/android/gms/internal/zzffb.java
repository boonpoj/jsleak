...
public abstract class zzffb {
    ...
    public static zzffb zzb(byte[] bArr, int i, int i2, boolean z) {
        zzffd zzffdVar = new zzffd(bArr, i, i2, z);
        try {
            zzffdVar.zzks(i2);
            return zzffdVar;
        } catch (zzfge e) {
    ...
    public abstract <T extends zzffu<T, ?>> T zza(T t, zzffm zzffmVar) throws IOException;

    public abstract void zza(zzfhf zzfhfVar, zzffm zzffmVar) throws IOException;

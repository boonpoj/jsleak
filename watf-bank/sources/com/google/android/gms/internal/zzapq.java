...
public interface zzapq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzapq {
        ...
        /* loaded from: assets/classes2.dex */
        private static class C0007zza implements zzapq {
        ...
        public static zzapq asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof zzapq)) ? new C0007zza(iBinder) : (zzapq) queryLocalInterface;
        }

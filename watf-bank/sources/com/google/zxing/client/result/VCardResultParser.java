...
public final class VCardResultParser extends ResultParser {
        ...
        while (i2 < length) {
            ...
            if (group != null) {
                ...
                while (i4 < length2) {
                    ...
                    arrayList.add(str3);
                    String[] split2 = EQUALS.split(str3, i3);
                    if (split2.length > 1) {
    ...
    public AddressBookParsedResult parse(Result result) {
        ...
        if (matcher.find() && matcher.start() == 0) {
            ...
            List<List<String>> matchVCardPrefixedField5 = matchVCardPrefixedField(MoPubBrowser.DESTINATION_URL_KEY, massagedText, true, false);

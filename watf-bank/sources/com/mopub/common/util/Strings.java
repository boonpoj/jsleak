...
public class Strings {
    ...
    private static Pattern f637 = Pattern.compile("((\\d{1,2})|(100))%");

    /* renamed from: ࢢ  reason: contains not printable characters */
    private static Pattern f638 = Pattern.compile("\\d{2}:\\d{2}:\\d{2}(.\\d{3})?");
    ...
    public static boolean isAbsoluteTracker(String str) {
        return !TextUtils.isEmpty(str) && f638.matcher(str).matches();
    }

    public static boolean isPercentageTracker(String str) {
        return !TextUtils.isEmpty(str) && f637.matcher(str).matches();
    }

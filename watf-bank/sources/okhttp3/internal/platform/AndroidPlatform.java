    ...
    public static Platform buildIfSupported() {
        ...
        try {
            ...
            try {
                ...
                setAlpnProtocols = getAlpnSelectedProtocol;
            } catch (ClassNotFoundException e2) {
                setAlpnProtocols = getAlpnSelectedProtocol;
                setAlpnProtocols2 = null;
            }
            return new AndroidPlatform(sslParametersClass, setUseSessionTickets, setHostname, setAlpnProtocols, setAlpnProtocols2);
